        ...
        <div className="w-full mx-auto flex-grow flex flex-col justify-between">
          ...
          >
            ...
            <div>
              ...
              >
                <option value="postgres" className="text-gray-900">
                  PostgreSQL
                </option>
              </select>
              {/* Botão de Login */}
          ...
          <Link
            to="/register"
            className="text-center text-white opacity-60 hover:opacity-100 font-extralight text-[16px] sm:text-[20px] cursor-pointer mt-0.5"
          >
            Register
          </Link>
        </div>
