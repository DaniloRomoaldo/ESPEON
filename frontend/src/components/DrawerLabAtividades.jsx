...
export default function DrawerLabAtividades({
  isOpen,
  onClose,
  editorContent,
}) {
  ...
  const handleSubmitAnswer = async () => {
    ...
    try {
      const body = {
        listName: currentExercise.name_list,
      ...
      >
        ...
        {labSessionId && exercises.length > 0 && currentExercise ? (
          ...
          <p className="mb-6 text-sm text-gray-500 dark:text-gray-400">
            Nenhuma sessão de laboratório ativa. Inicie um laboratório na página
            ...
            <button
              ...
              onClick={() =>
                setModalConfig({
                  ...
                  action: "stop",
                  message:
                    "Tem certeza que deseja encerrar a sessão do laboratório? O ambiente será destruído.",
                })
              }
