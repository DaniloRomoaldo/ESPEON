...
export default function DatatableExerciseListsRow({
  list_name,
  qnt_exercicio,
  id,
  created_at,
  ...
  return (
    <>
      <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
        ...
        <td className="px-6 py-4">{qnt_exercicio}</td>
          ...
          <a
            ...
            onClick={() =>
              setModalConfig({
                isOpen: true,
                action: "delete",
                message: `Tem certeza que deseja deletar a lista "${list_name}"?`,
              })
            }
          ...
          <a
            ...
            onClick={() =>
              setModalConfig({
                isOpen: true,
                action: "start",
                message: `Deseja iniciar um laboratório para a lista de exercícios "${list_name}"?`,
              })
            }
            className="group font-medium text-green-600 dark:text-green-600 hover:underline cursor-pointer"
          >
            {isLoading ? (
              "Iniciando..."
            ) : (
              <svg
                ...
                className="transition-all duration-200 group-hover:fill-green-600"
              >
      ...
      <ConfirmationModal
        ...
        onClose={() =>
          setModalConfig({ isOpen: false, action: null, message: "" })
        }
        onConfirm={handleConfirmAction}
        message={modalConfig.message}
        confirmText={
          modalConfig.action === "delete" ? "Sim, deletar" : "Sim, iniciar"
        }
